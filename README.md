...
* Сервер проверяет существование ключа перед обработкой
* При повторном запросе с тем же ключом возвращается кэшированный ответ
* Гарантируется отсутствие дублирующих операций

добавлен  `"idempotency_key": "unique_key_12345"`
в метод POST `http://arch.homework/api/v1/orders`
